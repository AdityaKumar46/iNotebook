        ...
        <div>
            <form onSubmit={handleSubmit}>
                <div className="mb-3">
                    ...
                    <input type="email" className="form-control" onChange={onChange} id="email"
                     name={credential.email} value={credential.email}  aria-describedby="emailHelp" />
                    <div id="emailHelp" className="form-text">We'll never share your email with anyone else.</div>
                </div>
                <div className="mb-3">
                    <label htmlFor="exampleInputPassword1" className="form-label">Password</label>
                    <input type="password" className="form-control" onChange={onChange} id="password"
                     name={credential.password} value={credential.password}/>
                </div>
