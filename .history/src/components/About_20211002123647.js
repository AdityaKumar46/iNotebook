...
function About() {
    const onClick=() => {
        <a href="https://guarded-river-08859.herokuapp.com/"></a>
    }
    return (
        <>
                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="https://guarded-river-08859.herokuapp.com/">g</a>
                                <button type="button" onClick={onClick} class="btn btn-primary">Primary</button>
                            </div>
                        </div>
                    </div>
                    <div class="col">
